...
public class OVRUtils
{
	...
	public static void SetWorldTransform(ref GameObject gameObject, ref Transform xfrm)
	{
		gameObject.transform.position = xfrm.localPosition;
		gameObject.transform.rotation = xfrm.localRotation;
		gameObject.transform.localScale    = xfrm.localScale;
	}
